...
void CreateVarSymbol(char* type, char* name, int isArray, int size, int scope, int line); // 创建变量符号表结点
void CreateFuncSymbol(int tag, char* type, char* name, int paramNum, int line); // 创建函数符号表结点
